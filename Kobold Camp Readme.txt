...
The following are changed in order to make most stones unmineable:
	inorganic_stone_mineral.txt
	material_template.txt

The following vanilla's have also been changed:

	entity_default has been changed (Skulking entity reworked for kobolds, civ_controllable tag removed from dwarves, as well as trade triggers so that the dwarves will trade with kobolds.)
	creature_standard has also been changed to modify the kobold raws, all other creatures remain the same.
...
Any and all comments/suggestions and/or complaints can be messaged to Lagotrope of the DF Forums, or commented on the DFFD download page at http://dffd.wimbli.com/file.php?id=2071
The current DF forum thread: http://www.bay12forums.com/smf/index.php?topic=52540.0
